...
const ELEVATED: Rgb888 = Rgb888::new(0x44, 0x47, 0x5a);
const TEXT: Rgb888 = Rgb888::new(0xf8, 0xf8, 0xf2);
const TEXT_MUTED: Rgb888 = Rgb888::new(0x62, 0x72, 0xa4);
const TEXT_FAINT: Rgb888 = Rgb888::new(0x44, 0x47, 0x5a);
// Dracula `comment` (#6272a4) — sits one tier above `current line`
// (ELEVATED) so button strokes contrast against the button fill.
